...
Researching on the Acts of Sri Lanka. The objective of this exercise is to figure out what are the Acts related to the insitutes like Departments in the Sri Lankan government. In parallel to that, understanding what an Act represents and its anatomoy is an interesting area to research. An Act is a guideline on performing certain duties which basically become the standard protocol to its functionality. To see if an entity is functioning as expected, a deeper understanding into an Act is required. 

## Data

The data is available in the [acts](https://documents.gov.lk/view/acts/acts.html) repository.
But this data has been already archived and periodically updated by [nuuuwan](https://github.com/nuuuwan) in [here](https://github.com/nuuuwan/lk_legal_docs/). 
...
[Governance Evolution Execution to Equipoise](docs/assets/documents/Governance_Evolution_Execution_to_Equipoise.pdf)

The comparative analysis of three acts is illustrated below:

![Comparison of three acts](docs/assets/images/comparison-of-three-acts.png)
